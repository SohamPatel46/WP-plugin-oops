 ...
 *
 * @package demo-oops-featuers
 */

namespace Demo_oops\Features\Inc\Helpers;
...
function autoloader( $resource = '' ) {
	...
	$resource_path  = false;
	$namespace_root = 'Demo_oops\Features\\';
	...
	if ( 'inc' === $path[0] ) {
		...
		$resource_path = sprintf( '%s/inc/%s/%s.php', untrailingslashit( DEMO_OOPS_FEATURES_PATH ), $directory, $file_name );
...
spl_autoload_register( '\Demo_oops\Features\Inc\Helpers\autoloader' );
